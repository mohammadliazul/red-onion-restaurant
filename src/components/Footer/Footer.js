            ...
            <div className="max-w-screen-xl mx-auto px-6">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
                        <div className="footer-widgets">
                            <ul className="text-white">
                                ...
                                <li className='hover:text-rose-600 transition duration-500'><a href="/add-your-restaurant">Add your restaurant</a></li>
                            </ul>
                        </div>
                        <div className="footer-widgets">
                            <ul className=" text-white">
                                ...
                                <li className='hover:text-rose-600 transition duration-500'><a href="/near-me">Restaurants near me</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="footer-widgets">
                            <ul className="flex lg:block justify-between text-white">
                                ...
                                <li className='hover:text-rose-600 transition duration-500'><a className='flex items-center gap-2' href="/youtube"><FaYoutube/><span className='hidden lg:block'>Youtube</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center flex-wrap-reverse justify-between pt-24">
                    <div className='mt-6 lg:mt-0'>
                        <span className="text-gray-500">Copyright &copy; 2022 Red Onion Foods. Developed by <span className='text-rose-600'>❤</span> <a className='hover:underline hover:text-green-500' href="https://www.linkedin.com/in/liazul/">Liazul</a></span>
                    </div>

                    <div className=''>
                        <ul className="flex text-white">
                            <li className="hover:text-rose-600 transition duration-500"><a href="/privacy-policy">Privacy Policy</a></li>
                            <li className="hover:text-rose-600 transition duration-500 ml-3"><a href="/terms-of-use">Terms of Use</a></li>
                            <li className="hover:text-rose-600 transition duration-500 ml-3"><a href="/pricing">Pricing</a></li>
                        </ul>
                    </div>
                </div>
            </div>
